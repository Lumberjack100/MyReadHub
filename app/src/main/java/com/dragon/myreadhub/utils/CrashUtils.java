...
public class CrashUtils
{
    ...
    static
    {
        try
        {
            PackageInfo pi = MyReadHub.getContext().getPackageManager().getPackageInfo(MyReadHub.getContext().getPackageName(), 0);
            if (pi != null)
            {
    ...
    public static void init(final String crashDirPath, final OnCrashListener onCrashListener)
    {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && MyReadHub.getContext().getExternalCacheDir() != null)
        {
            defaultDir = MyReadHub.getContext().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
        else
        {
            defaultDir = MyReadHub.getContext().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
